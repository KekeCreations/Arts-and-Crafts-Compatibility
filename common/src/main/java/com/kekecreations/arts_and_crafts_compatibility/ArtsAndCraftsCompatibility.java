...
public class ArtsAndCraftsCompatibility {
    ...
    public static void init() {
        ...
        ArtsAndCraftsCompatibility.LOG.info("Hello from Common init on {}! we are currently in a {} environment!", Services.PLATFORM.getPlatformName(), Services.PLATFORM.getEnvironmentName());
        ArtsAndCraftsCompatibility.LOG.info("The ID for diamonds is {}", BuiltInRegistries.ITEM.getKey(Items.DIAMOND));
